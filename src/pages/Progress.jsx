  ...
  return (
    <>
      ...
      <div style={{ display: "flex" }} className="side">
        ...
        <main style={{ marginLeft: "230px", padding: "1rem" }}></main>
      </div>
                ...
                {courses.length === 0 ? (
                  ...
                  courses.map((course, idx) => {
                    ...
                    if (typeof course.progress === "number") {
                      ...
                      typeof course.progress === "string" &&
                      course.progress.trim() !== ""
                    ) {
                      const parsed = parseInt(course.progress, 10);
                      progress = isNaN(parsed)
                        ? 0
                    ...
                    return (
                      <div className="cp-chart-item" key={course.id || idx}>
                        ...
                        <div className="bottom">
                          ...
                          <div className="cp-chart-item-percentage">
                            {progress}%
                          </div>
                        </div>
                      </div>
          ...
          <section className="weekly-study-time">
            <div className="wst">
              <h2>
                ...
                <HiOutlineChartBar
                  color="#f9f9f9"
                  style={{ fill: "#1e40af", marginRight: "10px" }}
                />
                Weekly Study Time
              </h2>
              ...
              <div className="milestone-list">
                <div className="milestone-item">
                  ...
                  <div>
                    ...
                    <p className="milestone-desc">
                      You studied for 7 days in a row!
                    </p>
                  </div>
                </div>
                ...
                <div className="milestone-item">
                  ...
                  <div>
                    ...
                    <p className="milestone-desc">
                      Logged study hours every week for a month
                    </p>
                  </div>
                </div>
                ...
                <div className="milestone-item">
                  ...
                  <div>
                    ...
                    <p className="milestone-desc">
                      Completed a full month of study!
                    </p>
                  </div>
                </div>
              </div>
