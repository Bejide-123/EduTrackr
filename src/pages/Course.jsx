...
const Course = () => {
  ...
  const getProgress = (courseCode, topics = []) => {
    ...
    const completed =
      JSON.parse(localStorage.getItem(`completedTopics_${courseCode}`)) || [];
  ...
  const openDetails = (course) => {
    ...
    const completed =
      JSON.parse(localStorage.getItem(`completedTopics_${course.code}`)) || [];
  ...
  const toggleTopic = (index) => {
    ...
    if (selectedCourse?.code) {
      ...
      const newProgress = Math.round(
        (updated.length / (selectedCourse.topics?.length || 1)) * 100
      );
              ...
              courses.map((course, index) => (
                <div className="courses-card" key={index}>
                  ...
                  <p className="lecturer">
                    <FaUser size={16} style={{ marginRight: "6px" }} /> By
                  ...
                  <div className="btns">
                    <button
                      ...
                      onClick={() => navigate(`/resume-course/${course.id}`)}
                    >
                      Resume Course
                    </button>
                  </div>
              ...
              <div className="popup-content">
                ...
                <div className="progress-section">
                  ...
                  <p className="progress-text">
                    {getProgress(selectedCourse.code, selectedCourse.topics)}% completed
                  </p>
                </div>
